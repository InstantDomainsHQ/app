package com.getinstantdomains.api.security.firebase;
...
import com.getinstantdomains.api.security.SecurityTestConfiguration;
...
public class FirebaseServiceIntegrationTest extends AbstractTestNGSpringContextTests {
    ...
    private final String demoUserEmail = UUID.randomUUID() + "@getinstantdomains.com";
    private final String demoUserDisplayName = "Domain Man";
