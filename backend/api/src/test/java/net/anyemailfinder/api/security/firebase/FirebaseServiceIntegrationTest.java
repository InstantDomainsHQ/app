package net.anyemailfinder.api.security.firebase;
...
import net.anyemailfinder.api.security.SecurityTestConfiguration;
...
public class FirebaseServiceIntegrationTest extends AbstractTestNGSpringContextTests {
    ...
    private final String demoUserEmail = UUID.randomUUID() + "@anyemailfinder.net";
