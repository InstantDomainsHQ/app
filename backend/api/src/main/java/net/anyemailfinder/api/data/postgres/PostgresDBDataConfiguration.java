package net.anyemailfinder.api.data.postgres;
...
@EnableJpaRepositories(
        ...
        basePackages = { "net.anyemailfinder.api.data.postgres.repo" }
)
...
public class PostgresDBDataConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan("net.anyemailfinder.api.data.postgres.entity");
        em.setPersistenceUnitName("hreachDb");
