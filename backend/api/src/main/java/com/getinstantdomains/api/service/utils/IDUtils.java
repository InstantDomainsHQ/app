package com.getinstantdomains.api.service.utils;
...
public class IDUtils {
  ...
  public static String generateCodeVersion() {
    return IDUtils.generateUid(IDUtils.SHORT_UID_LENGTH);
  }
  ...
  public static void httpRequest(Object body, String url, String caller, String authorization) {
    try (CloseableHttpClient httpClient = HttpClients.custom().build()) {
      ...
      StringEntity entityBody = IDUtils.getEntityBody(body);
