...
import com.getinstantdomains.api.props.StaffProps;
...
public class FirebaseServiceImpl implements FirebaseService {
    ...
    public String getAllUsers(PageableRequest pageableRequest) {
        SessionUser user = IDUtils.getSessionUser();
        if (!staffProps.getEmails().contains(user.getEmail())) {
            IDUtils.raiseHttpError(httpServletResponse, objectMapper, "Unauthorized",
        ...
        try {
            ...
            for (ExportedUserRecord record : usersResult.getValues()) {
                Pair<String, String> name = IDUtils.parseFullName(WordUtils.capitalize(record.getDisplayName()));
